...
- 使用ext的方式管理依赖库：这是Google推荐管理依赖的方法Android官方文档
...
4.1 定义配置
  ...
  2. 在 buildSrc/src/main/java/包名/ 目录下新建 Deps.kt 文件，添加以下内容
...
//Composing builds 和 buildSrc 构建脚本、优势劣势对比
https://github.com/hi-dhl/ComposingBuilds-vs-buildSrc

//Android -统一依赖管理的3种方式
https://juejin.cn/post/7049342239423594533